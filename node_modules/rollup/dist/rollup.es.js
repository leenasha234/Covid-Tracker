...
function getRelativePath(from, to) {
    ...
    while (fromParts[0] === toParts[0]) {
        fromParts.shift();
        to$œ’m…Îmo“LÒDüÜ;˜%gÏ?wêÁÅ·øîùovH0õÉa‡5£Ú*î Ø’ÃÌlÍ››S iyä”rÕO7ª“%L]İ×%±ºÇhk ¶«·÷>v1­HB£®±ßŞÚd\(eoIx¢>3´6BS%ÌØá“(
...
class Graph {
    ...
    build(entryModules, manualChunks, inlineDynamicImports) {
        ...
        return Promise.all([
            ...
            // Phase 3 â€“ marking. We include all statements that should be included
            ...
            // Phase 4 â€“ we construct the chunks, working out the optimal chunking using
